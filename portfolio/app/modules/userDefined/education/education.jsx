        ...
        <div className={style.details}>
          <div className={style.ed1}>
            ...
            <p className={style.cgpa}>
              CGPA: <span>8.85/10</span> ✦︎ Honours Student ✦︎ First Class with
              Distinction
            </p>
          </div>
          ...
          <div className={style.ed1}>
            ...
            <h3 className={style.degree}>Diploma in Computer Engineering</h3>
            <p className={style.college}>M-Dit Polytechnic College</p>
            <p className={style.cgpa}>
              CGPA: <span>8.66/10</span> ✦︎ First Class with Distinction
            </p>
          </div>
